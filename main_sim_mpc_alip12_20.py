import numpy as np
import time
import MPC_LIP_sig_step12_20
import gymnasium as gym
from gymnasium.envs.registration import register
from data_procs.logger12_20 import Logger
...
if __name__ == "__main__":
	...
	mpc_cbf1 = MPC_LIP_sig_step12_20.MPCCBF(goal, obs_list, obs_safe, margin)
	...
	max_traj_len = 15000 #max_episode_length in walking steps
	i = 0
	traj_len = 0
	num_step = 1
	torso_fixed = False
	...
	while traj_len < max_traj_len:
		...
		if i == 0:
			logger.set_stf_head(mpc_cbf1, num_step)
