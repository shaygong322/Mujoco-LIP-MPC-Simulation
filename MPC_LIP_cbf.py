...
class MPCCBF:
    def __init__(self, goals, cir_param, cir_cbf, elp_param, elp_cbf, margin, step = 3):
        ...
        # Constraints param
        self.leg = 0.11                ## leg length square
        self.x_max = 5
        self.bvx_max = 0.8
        self.bvx_min = -0.5
        self.bvy_max = 0.35
        self.bvy_min = 0.05
        self.ang_max = math.pi/8
...
class LIP_Prob:
    ...
    def jacobian(self, u):
        ...
        jac = np.concatenate([dv11_du, dv21_du, dCBF1_cir, dCBF1_elp, df1, theta_con1, 
                              dv12_du, dv22_du, dCBF2_cir, dCBF2_elp, df2, theta_con2, 
                              dv13_du, dv23_du, dCBF3_cir, dCBF3_elp, df3, theta_con3])
        return jac
